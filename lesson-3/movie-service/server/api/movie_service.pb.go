...
func (x *GetMovieResponse) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetMovieResponse) GetMovieUrl() string {
	if x != nil {
		return x.MovieUrl
	}
	return ""
...
var file_movie_service_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x2c, 0x0a, 0x0f, 0x47, 0x65,
	0x74, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a,
	0x08, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x07, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x49, 0x64, 0x22, 0x6b, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x4d,
	...
	0x52, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x65, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x6f, 0x76, 0x69,
	0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x6f, 0x76,
	0x69, 0x65, 0x55, 0x72, 0x6c, 0x32, 0x42, 0x0a, 0x05, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x12, 0x39,
	...
	0x1a, 0x15, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x52,
...
var file_movie_service_proto_goTypes = []interface{}{
	(*GetMovieRequest)(nil),  // 0: api.GetMovieRequest
	(*GetMovieResponse)(nil), // 1: api.GetMovieResponse
}
var file_movie_service_proto_depIdxs = []int32{
	0, // 0: api.Movie.GetMovie:input_type -> api.GetMovieRequest
	1, // 1: api.Movie.GetMovie:output_type -> api.GetMovieResponse
...
func (c *movieClient) GetMovie(ctx context.Context, in *GetMovieRequest, opts ...grpc.CallOption) (*GetMovieResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.Movie/GetMovie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
